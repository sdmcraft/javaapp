...
public class JMSservlet extends javax.servlet.http.HttpServlet implements
    ...
    public void init() {
        ...
        try {
            ...
            getServletContext().setAttribute("queueConnectionFactory", queueConnectionFactory);
            ...
            getServletContext().setAttribute("queueConnection", queueConnection);
    ...
    public void destroy() {
        try {
            ((QueueConnection) getServletContext().getAttribute("queueConnection")).close();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        QueueConnection queueConnection = (QueueConnection) getServletContext().getAttribute("queueConnection");
        ...
        try {
            ...
            if ("consume".equals(request.getParameter("action"))) {

                QueueReceiver queueReceiver = queueSession.createReceiver(testQueue);
                TextMessage textMessage = null;
                while ((textMessage = (TextMessage) queueReceiver.receiveNoWait()) != null) {
                    out.write("<BR>");
