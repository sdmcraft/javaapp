...
public class GraphUtils
{
    ...
    public static final <T> void getDistances(Graph<T> graph, Node<T> startNode, Map<Node<T>, List<Node<T>>> pathMap) throws InvalidDataException
    {
        /*
        ...
        while (nodeList.size() > 0)
        {
            ...
            for (Node<T> neighbour : neighbours)
            {
                 ...
                 * minimum cost
                 */
                Set<Edge<T>> edgesToNeighbour = graph.getEdges(currentNode, neighbour);
                ...
                if (neighbourIndex == -1)
                {
                    NodeDistance neighbourDistance = new NodeDistance(neighbour, currentNodeDistance.distance + minEdgeWeight);
                ...
                */
                else if (nodeList.get(neighbourIndex).distance > (currentNodeDistance.distance + minEdgeWeight))
                {
                    System.out.println("Branch hit");
                    nodeList.get(neighbourIndex).distance = currentNodeDistance.distance + minEdgeWeight;
            ...
            System.out.println("Node:" + currentNode + " Minimum Cost:" + currentNodeDistance.distance);
            /*
