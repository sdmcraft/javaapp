...
public class Heap
{
    ...
    public void trickledown(int index)
    {
        ...
        while ((leftChildIndex < heapSize) && (rtChildIndex < heapSize) && ((item.weight < nodes[leftChildIndex].weight) || (item.weight < nodes[rtChildIndex].weight)))
        {
    ...
    public static void trickledown(int index, HeapNode[] arr)
    {
        ...
        while ((leftChildIndex < arr.length) && (rtChildIndex < arr.length) && ((item.weight < arr[leftChildIndex].weight) || (item.weight < arr[rtChildIndex].weight)))
        {
    ...
    private BinaryTree toBinaryTree(int index)
    {
        if (index < heapSize)
        {
            ...
            BinaryTree binaryTree = new BinaryTree(node.data + "(" + node.weight + ")");
    ...
    public static void main(String[] args)
    {
         ...
         */
        String text = "In the testing environment we do not currently allow International dial out, " + "the fact it is dialing strikes me as odd as it shouldn't be doing that either. This is " +
            "something Jeff and I have been trying to get implemented before. We will try to push to get this " + "enabled for your testing. For the meantime though, you will have to do dial ins";
