...
{
    public static List<String> delimitedReader(String delimiter, File f) throws IOException, InterruptedException
    {
        List<String> result = new ArrayList<String>();
        List<Byte> content = new ArrayList<Byte>();
        byte[] delimBytes = delimiter.getBytes();

        PushbackInputStream pbin = new PushbackInputStream(new FileInputStream(f), delimBytes.length);
    ...
    public static final boolean compare(File f1, File f2) throws Exception
    {
    ...
    public static final FilenameFilter getFileExtFilter(final String ext)
    {
        return new FilenameFilter()
            {
                public boolean accept(File dir, String fileName)
    ...
    public static String replace(String s, Map<String, String> idMap, String splitRegex)
    {
    ...
    public static String readLineFromFile(int lineNum, String filePath) throws IOException
    {
        LineNumberReader lineReader = new LineNumberReader(new BufferedReader(new FileReader(filePath)));
        int count = 0;
        String result = null;
    ...
    public static String[] fileToArray(String file, int start, int end) throws Exception
    {
        LineNumberReader lineReader = new LineNumberReader(new BufferedReader(new FileReader(file)));
    ...
    public static void arrayToFile(Object[] array, String file) throws Exception
    {
        PrintWriter pw = new PrintWriter(file);
    ...
    public static void replace(String file, int start, String[] replacement) throws Exception
    {
        LineNumberReader lineReader = new LineNumberReader(new BufferedReader(new FileReader(file)));
        ...
        while ((lineReader.readLine() != null) && (count < (start + replacement.length)))
        {
            count++;
