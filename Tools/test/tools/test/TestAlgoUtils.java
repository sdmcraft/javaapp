...
public class TestAlgoUtils {
	...
	public void testSort() throws Exception {
		...
		Arrays.sort(ref);
		System.out.println("Time consumed(JDK sort):"
		...
		System.out.println("Time consumed(Bubble sort):"
				+ (System.currentTimeMillis() - time));
		...
		System.out.println("Time consumed(Quick sort):"
				+ (System.currentTimeMillis() - time));
		...
		System.out.println("Time consumed(selection sort):"
				+ (System.currentTimeMillis() - time));
		...
		System.out.println("Time consumed(insertion sort):"
				+ (System.currentTimeMillis() - time));
		...
		System.out.println("Time consumed(shell sort):"
				+ (System.currentTimeMillis() - time));
		...
		System.out.println("Time consumed(merge sort):"
				+ (System.currentTimeMillis() - time));

		/*
		 * int[] counting = DSUtils.arrayCopy(input); time =
		 * System.currentTimeMillis(); AlgoUtils.countingSort(counting);
		 * Assert.assertEquals(true, DSUtils.arrayCompare(ref, counting));
		 * System.out.println("Time consumed(counting sort):" +
		 * (System.currentTimeMillis() - time));
		 */
		...
		time = System.currentTimeMillis();
		AlgoUtils.externalSort(new File("c:\\temp1\\input.txt"), "C:\\temp1",
				10000);
		external = DSUtils.stringArrayToIntArray(IOUtils
				.fileToArray("C:\\temp1\\output.txt"));
		Assert.assertEquals(true, DSUtils.arrayCompare(ref, external));
		System.out.println("Time consumed(external sort):"
				+ (System.currentTimeMillis() - time));
