...
public class TestAlgoUtils
{
    ...
    {
        Assert.assertEquals(3, AlgoUtils.binarySearch(new int[] { -3, -2, -1, 1, 2, 3 }, 0));
        Assert.assertEquals(3, AlgoUtils.binarySearch(new int[] { -3, -2, -1, 0, 1, 2, 3 }, 0));
        Assert.assertEquals(3, AlgoUtils.binarySearch(new int[] { -3, -2, -1 }, 0));
