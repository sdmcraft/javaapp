...
public class EncryptUtils {
	public static KeyPair generateKeyPair(String publicKeyFile,
	...
	public static PublicKey readKeyFromString(String keyString)
			throws IOException {
		ObjectInputStream oin = new ObjectInputStream(new BufferedInputStream(
				new ByteArrayInputStream(keyString.getBytes("UTF-8"))));
		try {
	...
	public static String rsaDecrypt(String cipherData, Key key)
			throws Exception {
